...
subjects='BEIG0414g' # Beignet on 04-14-2022
run_num=16
...
NEP=200 # number of epochs                         -- was 200 for run 1-3, 7, 15
nopts=50 # number of times to update pseudo-labels -- was  50 for run 1-3, 7, 15
...
# NEP=60 # number of epochs                           -- was 40 for run 1-3, 60 for run 4, 100 for run 5, 60 for run 6-16
# nopts=40 # number of times to update pseudo-labels  -- was 20 for run 1-3, 40 for run 4,  50 for run 5, 40 for run 6-16
